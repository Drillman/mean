...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_angular2_flash_messages_module__ = __webpack_require__("./node_modules/angular2-flash-messages/module/index.js");
...
module.exports = "<div class=\"jumbotron text-center\">\n    <h1>MEAN Authentification App</h1>\n    <p class=\"lead\">This app has been built from scratch</p>\n    <div>\n        <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a>\n        <a class=\"btn btn-primary\" [routerLink]=\"['/login']\">Login</a>\n    </div>\n</div>\n"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this.flashMessage.show('Hi ' + data.user.name + ' !', { cssClass: "alert-success", timeout: 3000 });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.authService.registerUser(user).subscribe(function (data) {
                    if (data.success) {
                        _this.flashMessages.show('You are now resgistered and can log in', { cssClass: "alert-success", timeout: 3000 });
                        _this.router.navigate(['/dashboard']);
                    }
                    else {
